...
const MOTIFS = [
  { glyph: '✧', left: '10%', top: '14%', delay: 0, size: 15 },
  { glyph: '♡', left: '82%', top: '20%', delay: 350, size: 16 },
  { glyph: '❀', left: '18%', top: '72%', delay: 700, size: 14 },
  { glyph: '✧', left: '76%', top: '68%', delay: 200, size: 13 },
  { glyph: '♡', left: '48%', top: '8%', delay: 500, size: 12 },
];
...
function Motif({ glyph, left, top, delay, size }) {
  ...
  const opacity = anim.interpolate({ inputRange: [0, 0.5, 1], outputRange: [0.12, 0.32, 0.12] });
  const rotate = anim.interpolate({ inputRange: [0, 1], outputRange: ['-5deg', '6deg'] });
